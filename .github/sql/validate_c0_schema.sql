...
/* V2 — exact columns, SQL type, character length, precision/scale, nullability and identity */
...
(
 ...
 is_nullable bit, is_identity bit,
 PRIMARY KEY(table_name,column_name)
);
INSERT INTO @expected_columns VALUES
(N'c0_input',N'input_row_id',N'bigint',NULL,19,0,0,1),
(N'c0_input',N'decision_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_input',N'scenario_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_input',N'article_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_input',N'supplier_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_input',N'quantity',N'decimal',NULL,38,4,0,0),
(N'c0_input',N'unit_price',N'decimal',NULL,38,4,0,0),
(N'c0_input',N'currency',N'char',3,NULL,NULL,0,0),
(N'c0_input',N'operation_date',N'date',NULL,NULL,NULL,0,0),
(N'c0_input',N'input_fingerprint',N'char',64,NULL,NULL,0,0),
(N'c0_context',N'context_row_id',N'bigint',NULL,19,0,0,1),
(N'c0_context',N'decision_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_context',N'scenario_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_context',N'rules_version',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_context',N'parameters_version',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_context',N'data_snapshot_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_evidence',N'evidence_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_evidence',N'source_type',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_evidence',N'source_ref',N'nvarchar',256,NULL,NULL,0,0),
(N'c0_evidence',N'captured_at',N'date',NULL,NULL,NULL,0,0),
(N'c0_evidence',N'state',N'varchar',16,NULL,NULL,0,0),
(N'c0_evidence',N'demonstration_ref',N'nvarchar',256,NULL,NULL,1,0),
(N'c0_evidence_validation',N'evidence_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_evidence_validation',N'status',N'varchar',8,NULL,NULL,0,0),
(N'c0_evidence_validation',N'reason',N'nvarchar',256,NULL,NULL,0,0),
(N'c0_rule_contract',N'rule_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_rule_contract',N'version',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_rule_contract',N'requires_evidence',N'bit',NULL,NULL,NULL,0,0),
(N'c0_assessment',N'assessment_row_id',N'bigint',NULL,19,0,0,1),
(N'c0_assessment',N'rule_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_assessment',N'status',N'varchar',16,NULL,NULL,0,0),
(N'c0_assessment',N'outcome',N'bit',NULL,NULL,NULL,1,0),
(N'c0_assessment',N'reason',N'nvarchar',256,NULL,NULL,0,0),
(N'c0_assessment_evidence',N'assessment_row_id',N'bigint',NULL,19,0,0,0),
(N'c0_assessment_evidence',N'evidence_ordinal',N'int',NULL,10,0,0,0),
(N'c0_assessment_evidence',N'evidence_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_trace',N'trace_id',N'nvarchar',128,NULL,NULL,0,0),
(N'c0_trace',N'decision_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_trace',N'scenario_id',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_trace',N'rules_version',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_trace',N'parameters_version',N'nvarchar',64,NULL,NULL,0,0),
(N'c0_trace',N'data_snapshot_id',N'nvarchar',64,NULL,NULL,0,0),
...
(N'c0_trace',N'assessment_outcome',N'bit',NULL,NULL,NULL,1,0),
