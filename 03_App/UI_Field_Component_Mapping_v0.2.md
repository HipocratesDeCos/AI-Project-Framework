...
## Regla
Cada `UI-*` del Registro Maestro tiene una asignación primaria de componente UI. El componente no modifica semántica, estado ni autoridad.
...
## Salvaguarda STK
`UI-STK-007` y `UI-STK-008` pueden representarse visualmente, pero su cálculo queda bloqueado hasta disponer de autoridad metodológica.
