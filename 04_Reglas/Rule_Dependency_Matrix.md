...
| DEP-PAG-001-RPAG-002 | `R-PAG-002` | `PARAMETER` | `P-PAG-001` | PARAMETER | Plazo mínimo aceptable | PENDING | `04_Reglas/Especificacion_Reglas_Configuracion_Pagos_MVP.md`; `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md`; `08_Implementacion/PAG002_Minimum_Term_Financial_State_Technical_Contract_v0.1.md`; `08_Implementacion/R_PAG_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Binding físico materializado mediante `MinimumPaymentTermResolution`, sin hardcodear 60 días, y reconstruido internamente por R-PAG-002. PR #294 CI #1126; core PR #298 CI #1139 SUCCESS. |
| DEP-PAG-002-RPAG-001 | `R-PAG-001` | `PARAMETER` | `P-PAG-002` | PARAMETER | Plazo objetivo | PENDING | `04_Reglas/Especificacion_Reglas_Configuracion_Pagos_MVP.md`; `08_Implementacion/R_PAG_001_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Consumido por el core provenance-safe mediante `PaymentTermToleranceResolution`; no se acepta threshold desprendido. PR #291, CI #1118 SUCCESS. |
| DEP-PAG001-OFFERED-TERM | `R-PAG-001` | `DATA` | `OfferedPaymentTermObservation` | PAYMENT TERM | Escalar canónico de plazo ofrecido del proveedor actual en días | PENDING | `01_Modelo/PAG001_Offered_Payment_Term_Authority_v0.1.md`; `08_Implementacion/PAG001_Offered_Payment_Term_Adapter_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Carrier materializado por `PaymentTermObservationAdapter` desde Supplier Evidence con `PaymentTermSemanticAuthority` explícita y reconstruido internamente por el core R-PAG-001. No autoriza normalización multicuota. PR #280 CI #1087; core PR #291 CI #1118 SUCCESS. |
| DEP-PAG-003-RPAG-001 | `R-PAG-001` | `DERIVED` | `P-PAG-003` | PARAMETER | Modulación del objetivo de pago | PENDING | `04_Reglas/Especificacion_Reglas_Configuracion_Pagos_MVP.md`; `01_Modelo/PAG001_Payment_Term_Tolerance_Authority_v0.1.md`; `08_Implementacion/PAG001_Payment_Term_Tolerance_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Transformación materializada: `effective_threshold_days = P-PAG-002 - P-PAG-003`, con same-context `ResolvedConfiguration + ParameterConfigurationEvidence`, sin clamp ni conversión; el core R-PAG-001 la reconstruye y exige coherencia de `effective_at` también con P-PAG-004. PR #283 CI #1094; core PR #291 CI #1118 SUCCESS. |
| DEP-PAG-004-RPAG-001 | `R-PAG-001` | `CONTROL` | `P-PAG-004` | PARAMETER | Control de consideración del plazo | PENDING | `04_Reglas/Especificacion_Reglas_Configuracion_Pagos_MVP.md`; `01_Modelo/PAG001_Consider_Payment_Term_Control_Authority_v0.1.md`; `08_Implementacion/PAG001_Consider_Payment_Term_Control_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Control materializado: `Sí → ENABLED`, `No → DISABLED`; DISABLED preserva exclusión de criterio y no fabrica FALSE. Ausencia/config/evidence inválida → NOT_EVALUABLE. Reconstruido internamente por R-PAG-001. PR #286 CI #1102; core PR #291 CI #1118 SUCCESS. |
| DEP-PAG-004-RPAG-002 | `R-PAG-002` | `CONTROL` | `P-PAG-004` | PARAMETER | Control de consideración del plazo | PENDING | `04_Reglas/Especificacion_Reglas_Configuracion_Pagos_MVP.md`; `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md`; `08_Implementacion/R_PAG_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | `Sí → ENABLED`, `No → DISABLED → NOT_EVALUABLE`; el core R-PAG-002 lo reconstruye antes del análisis financiero. PR #298 CI #1139 SUCCESS. |
...
| DEP-PAG-005-RPAG-002 | `R-PAG-002` | `DERIVED` | `P-PAG-005` | PARAMETER | Contexto económico de negociación | PENDING | `04_Reglas/Especificacion_Reglas_Configuracion_Pagos_MVP.md`; `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Reconciliado como contexto económico opcional no bloqueante del core PAG002; no contiene fórmula de descuento. |
| DEP-PAG002-FINANCIAL-STATE | `R-PAG-002` | `DERIVED` | `PAG002FinancialStateResolution` | FINANCE | Estado financiero acotado a PAG002 derivado de `financial_capacity_forecast` frente a `P-FIN-002` | PENDING | `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md`; `08_Implementacion/PAG002_Minimum_Term_Financial_State_Technical_Contract_v0.1.md`; `08_Implementacion/R_PAG_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Baseline factual y scenario-only se clasifican contra P-FIN-002; el scenario usa fingerprint O2 y no fabrica Evidence del resultado simulado. Core PR #298 CI #1139 SUCCESS. |
| DEP-PAG002-CF-DUE-DATE | `R-PAG-002` | `DATA` | `CounterfactualPaymentSchedule` | PAYMENT SCHEDULE | Calendario minimum-term scenario-only de la operación exacta | PENDING | `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md`; `01_Modelo/PAG002_Counterfactual_Due_Date_Authority_v0.1.md`; `08_Implementacion/PAG002_Counterfactual_Due_Date_Technical_Contract_v0.1.md`; `08_Implementacion/R_PAG_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Gate cerrado para pago único: `new_due = baseline_due + (minimum-offered)` en días naturales enteros, `SCENARIO_ONLY`, O2 identity, sin mutar CashFlow factual. Multicuota permanece NOT_EVALUABLE. PR #297 CI #1134; core PR #298 CI #1139 SUCCESS. |
...
| DEP-HIS003-COMPARABILITY | `R-HIS-003` | `DERIVED` | `HistoricalCommercialComparabilityObservation` | HISTORICAL COMPARABILITY | Estado agregado de comparabilidad comercial de la referencia exacta | PENDING | `01_Modelo/HIS003_Commercial_Comparability_Authority_v0.1.md`; `08_Implementacion/R_HIS_003_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Carrier reconstruido dentro del bridge desde PriceReference + siete determinaciones dimensionales; no se acepta observation desprendida. PR #301, CI #1150 SUCCESS. |
| DEP-HIS003-DIMENSION-EVIDENCE | `R-HIS-003` | `EVIDENCE` | `HistoricalComparabilityDimensionDetermination + Evidence` | HISTORICAL COMPARABILITY | Demuestra EQUIVALENT / MATERIALLY_DIFFERENT / NOT_APPLICABLE o conserva NOT_DETERMINABLE por cada una de las siete dimensiones | PENDING | `01_Modelo/HIS003_Commercial_Comparability_Authority_v0.1.md`; `08_Implementacion/R_HIS_003_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Las determinaciones exigen autoridad/metodología/evidencia/traza explícitas. No existen productores empresariales genéricos autorizados: si falta autoridad upstream suficiente, la dimensión permanece NOT_DETERMINABLE. |
| DEP-HIS003-PRICE-BOUNDARY | `R-HIS-003` | `BOUNDARY` | `PriceReference` | PRICE / HISTORY | Identidad factual de la transacción histórica evaluada, sin promover PriceReferenceAssessment.comparability | PENDING | `01_Modelo/HIS003_Commercial_Comparability_Authority_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Price Intelligence COMPARABLE/NO_COMPARABLE no se mapea automáticamente a HIS003; solo la cadena específica de siete dimensiones autoriza TRUE/FALSE. |
| DEP-PROV001-SUPPLIER-EVIDENCE | `R-PROV-001` | `COMPONENT` | `SupplierEvidenceResult` | SUPPLIER EVIDENCE | Identidad y resolución factual de candidaturas alternativas aplicables a la operación exacta | PENDING | `01_Modelo/PROV_Supplier_Alternatives_Authority_v0.1.md`; `08_Implementacion/R_PROV_001_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | El bridge no acepta un resultado desprendido: reconstruye `SupplierEvidenceResult` desde `SupplierEvidenceInput → evaluate_supplier_evidence` y exige coherencia completa de contexto, artículo y proveedor actual. PR #305, CI #1158/#1159 SUCCESS. |
| DEP-PROV001-COVERAGE | `R-PROV-001` | `EVIDENCE` | `SupplierAlternativeSetCoverage + Evidence` | PROV AUTHORITY | Demuestra el estado de cobertura del universo de alternativas; `COMPLETE` es requisito para probar FALSE, no para un TRUE positivo | PENDING | `01_Modelo/PROV_Supplier_Alternatives_Authority_v0.1.md`; `08_Implementacion/R_PROV_001_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | `COMPLETE` requiere evidencia DEMONSTRATED vinculada al carrier exacto. `PARTIAL/NOT_DETERMINABLE` nunca se convierten en FALSE. |
| DEP-PROV001-OPPORTUNITY | `R-PROV-001` | `EVIDENCE` | `SupplierAlternativeOpportunityDetermination + Evidence` | PROV AUTHORITY | Determina por candidato `POTENTIALLY_BETTER / NOT_POTENTIALLY_BETTER / NOT_DETERMINABLE` sin derivarlo desde Supplier Evidence factual | PENDING | `01_Modelo/PROV_Supplier_Alternatives_Authority_v0.1.md`; `08_Implementacion/R_PROV_001_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Carrier concluyente exige evidencia DEMONSTRATED vinculada a su hash exacto; no existe productor empresarial genérico autorizado, por lo que su ausencia conserva NOT_DETERMINABLE/NOT_EVALUABLE. |
| DEP-PROV002-SUPPLIER-EVIDENCE | `R-PROV-002` | `COMPONENT` | `SupplierEvidenceResult` | SUPPLIER EVIDENCE | Identidad y resolución factual de candidaturas para aplicar comparabilidad y mejora al mismo candidato evidenciado | PENDING | `01_Modelo/PROV_Supplier_Alternatives_Authority_v0.1.md`; `08_Implementacion/R_PROV_001_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Se reconstruye internamente desde `SupplierEvidenceInput`; `EVIDENCED_CANDIDATE` no se promociona a COMPARABLE ni a SIGNIFICANT_IMPROVEMENT. PR #305, CI #1158/#1159 SUCCESS. |
| DEP-PROV002-COVERAGE | `R-PROV-002` | `EVIDENCE` | `SupplierAlternativeSetCoverage + Evidence` | PROV AUTHORITY | Demuestra exhaustividad del universo para permitir la prueba negativa de R-PROV-002 | PENDING | `01_Modelo/PROV_Supplier_Alternatives_Authority_v0.1.md`; `08_Implementacion/R_PROV_001_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | TRUE puede demostrarse con cobertura no completa; FALSE exige `COMPLETE` y universo totalmente resuelto. |
| DEP-PROV002-COMPARABILITY | `R-PROV-002` | `EVIDENCE` | `SupplierAlternativeComparabilityDetermination + Evidence` | PROV AUTHORITY | Determina por candidato `COMPARABLE / NOT_COMPARABLE / NOT_DETERMINABLE` | PENDING | `01_Modelo/PROV_Supplier_Alternatives_Authority_v0.1.md`; `08_Implementacion/R_PROV_001_002_Provenance_Safe_Core_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | No existe promoción automática desde `StructuralComparisonResult.state=STRUCTURALLY_COMPARABLE`; la determinación concluyente requiere autoridad/evidencia propia. |
...
| DEP-COM001-DISCOUNT-EVID | `R-COM-001` | `EVIDENCE` | `DiscountOpportunityEvidence + Evidence` | COMMERCIAL AUTHORITY | Demuestra oportunidad de descuento y aplicabilidad confirmada a la operación exacta | PENDING | `01_Modelo/COM001_COM002_Commercial_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | COMMERCIAL_CONDITION no se promociona automáticamente; AVAILABLE+CONFIRMED requiere refs DEMONSTRATED. |
| DEP-COM001-CRC | `R-COM-001` | `CONTROL` | `RuleMetadata(active_result=NEGOCIAR)` | CRC / COMMERCIAL | Activa negociación solo para descuento disponible y aplicable confirmado | PENDING | `01_Modelo/COM001_COM002_Commercial_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | CRC | R2/MEDIA; sin R1/R0. |
| DEP-COM002-RAPPEL-EVID | `R-COM-002` | `EVIDENCE` | `RappelApplicabilityEvidence + Evidence` | COMMERCIAL AUTHORITY | Demuestra acuerdo, aplicabilidad y base económica de rappel lineal confirmado | PENDING | `01_Modelo/COM001_COM002_Commercial_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Escalados, retroactividad y condición futura quedan NOT_EVALUABLE. |
| DEP-COM002-EFFECTIVE-COST | `R-COM-002` | `DERIVED` | `RappelEffectiveCostEvidence` | COMMERCIAL AUTHORITY | Deriva rebate_amount y effective_cost_after_rappel mediante Decimal para la operación exacta | PENDING | `01_Modelo/COM001_COM002_Commercial_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Cálculo local; no activa CEA/TCO ni Scenario Engine. |
| DEP-COM002-CRC | `R-COM-002` | `CONTROL` | `RuleMetadata(R3/MEDIA)` | CRC / COMMERCIAL | Conserva carácter informativo sin modificar por sí solo el resultado consolidado | PENDING | `01_Modelo/COM001_COM002_Commercial_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | CRC | Sin active_result específico. |
| DEP-ROT-WINDOW-RROT-001 | `R-ROT-001` | `PARAMETER` | `P-ROT-002 / ResolvedConfiguration` | ROT001 TRACK B AUTHORITY | Define la ventana inclusiva para frecuencia de eventos válidos; entero positivo en días, sin default | PENDING | `01_Modelo/ROT001_Track_B_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Exclusivo de R-ROT-001; P-ROT-001 no se reutiliza. |
| DEP-ROT-THRESHOLD-RROT-001 | `R-ROT-001` | `PARAMETER` | `P-ROT-003 / ResolvedConfiguration` | ROT001 TRACK B AUTHORITY | Umbral decimal positivo en eventos/día; activa la regla solo cuando metric < threshold | PENDING | `01_Modelo/ROT001_Track_B_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Igualdad con threshold no activa la regla; sin tolerancia implícita. |
| DEP-ROT-METRIC-SOURCE-RROT-001 | `R-ROT-001` | `DATA` | `RotationMetricSourceEvidence` | ROTATION / TRACK B | Fuente factual completa de eventos ya calificados upstream; no usa cantidades, stock, consumo ni demanda | PENDING | `01_Modelo/ROT001_Track_B_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Requiere coverage_state COMPLETE, semántica y completitud demostradas. |
| DEP-ROT-METRIC-EVID-RROT-001 | `R-ROT-001` | `DERIVED` | `RotationMetricEvidence` | ROTATION / TRACK B | Deriva determinísticamente valid_sale_event_count / rotation_window_days mediante Decimal | PENDING | `01_Modelo/ROT001_Track_B_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Métrica no desprendida; unidad eventos/día; sin redondeo previo a comparación. |
| DEP-ROT-CRC-RROT-001 | `R-ROT-001` | `CONTROL` | `RuleMetadata(active_result=NEGOCIAR)` | CRC / ROTATION | Preserva el resultado MVP NEGOCIAR con efecto R2/ALTA | PENDING | `01_Modelo/ROT001_Track_B_Completion_Package_Proposal_v0.1.md` | CONFIRMED | PENDING | NONE | CRC | NO COMPRAR, R1 y R0 automáticos permanecen fuera de alcance. |
...
| `StructuralComparisonResult` | `STRUCTURALLY_COMPARABLE → SupplierAlternativeComparabilityDetermination.COMPARABLE` | `REJECTED` como promoción automática; comparabilidad comercial PROV exige carrier autorizado propio. |
| `difference_decimal` / menor precio factual | promoción automática a `POTENTIALLY_BETTER` o `SIGNIFICANT_IMPROVEMENT` | `REJECTED`; Supplier Evidence mantiene naturaleza factual y PROV no inventa umbrales ni valoración. |
...
El cruce `R-PROV-001/R-PROV-002 ↔ Supplier Evidence + carriers PROV` deja de formar parte de los pendientes generales: el core provenance-safe quedó materializado por PR #305 y validado por CI #1158/#1159. Se confirman las dependencias de Supplier Evidence reconstruida, cobertura y determinaciones explícitas por candidato. Permanecen fuera de alcance los productores empresariales genéricos de `POTENTIALLY_BETTER`, `COMPARABLE` y `SIGNIFICANT_IMPROVEMENT`; la RDM no autoriza derivarlos desde comparabilidad estructural, `difference_decimal`, precio menor, scoring o ranking.
...
- `R-PAG-001` queda materializada e integrada en `run_domain_rules` mediante core provenance-safe; `P-PAG-005` permanece como enriquecimiento económico opcional separado y la normalización multicuota sigue fuera de alcance.
