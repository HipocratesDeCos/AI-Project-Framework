...
| DEP-PAG-004-RPAG-002 | `R-PAG-002` | `CONTROL` | `P-PAG-004` | PARAMETER | Control de consideración del plazo | PENDING | `04_Reglas/Especificacion_Reglas_Configuracion_Pagos_MVP.md`; `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Semántica extendida y autorizada: `Sí → ENABLED`, `No → DISABLED → R-PAG-002 NOT_EVALUABLE`; DISABLED nunca equivale a FALSE. |
...
| DEP-PAG002-FINANCIAL-STATE | `R-PAG-002` | `DERIVED` | `PAG002FinancialStateResolution` | FINANCE | Estado financiero acotado a PAG002 derivado de `financial_capacity_forecast` frente a `P-FIN-002` | PENDING | `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md`; `08_Implementacion/PAG002_Minimum_Term_Financial_State_Technical_Contract_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Clasificador materializado sobre `ProvenancedFinanceBasicExecution + P-FIN-002`; produce `PAG002_FINANCIALLY_VIABLE/NON_VIABLE/NOT_DETERMINABLE`. No genera calendario contrafactual. PR #294, CI #1126 SUCCESS. |
| DEP-PAG002-CF-DUE-DATE | `R-PAG-002` | `DATA` | `PaymentTermCounterfactualSchedule` | PAYMENT SCHEDULE | Calendario de pago minimum-term de la operación exacta | PENDING | `01_Modelo/PAG002_Financial_Viability_Counterfactual_Authority_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | **OPEN GATE**: no existe autoridad/productor para transformar vencimientos baseline a minimum-term sin inventar ancla temporal o semántica multicuota. || DEP-DAT-001-RDAT-001 | `R-DAT-001` | `PARAMETER` | `P-DAT-001` | PARAMETER | Antigüedad máxima del snapshot operativo evaluado | PENDING | `02_Parametros/Matriz_Parametros_Reglas_MVP.md`; `01_Modelo/DAT001_Data_Freshness_Authority_v0.1.md` | CONFIRMED | PENDING | NONE | NONE | Binding físico cerrado mediante `ResolvedConfiguration(P-DAT-001) + ParameterConfigurationEvidence`; PR #268, CI #1059 SUCCESS. No valida 6 semanas como política empresarial definitiva. |
