...
El contrato no convierte `configuration_ref` en prueba empresarial.
...
Los estados Track A tampoco sustituyen `Evidence.state` ni `EvidenceValidation.status`.
...
ROT002-AW-G04 → CLOSED — configuration Evidence preserved
