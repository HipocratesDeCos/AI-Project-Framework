...
En el momento de esta reconciliación, GitHub no expone un workflow ni status asociado directamente al merge commit; por tanto, **no se declara CI post-merge adicional como SUCCESS**. La evidencia CI válida para la materialización sigue siendo el workflow #383 sobre el código auditado.
