...
**Estado:** 🔒 CERRADO — MATERIALIZACIÓN TÉCNICA VALIDADA PENDIENTE DE CI
...
No se materializa todavía framework web, persistencia nueva, API pública, autenticación empresarial ni integración directa con motores internos.
...
La integración a `main` queda condicionada a ejecución y éxito del workflow de pruebas sobre la rama.

**No se considera materialización completa en `main` hasta disponer de CI satisfactorio y merge validado.**
