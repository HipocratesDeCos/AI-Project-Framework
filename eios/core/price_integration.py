...
class ObservedPriceInvoker(SingleUseObservedInvoker[PriceIntelligenceResult, PriceInvocationCapture]):
    ...
    def __init__(self, payload: PriceIntelligenceInput,
        ...
        super().__init__(
            label="PRICE", reference_case_id=reference_case_id,
            producer=lambda purchase, context: _produce_bound_price(
                self._payload, self._assessment, purchase, context,
            ),
            adapter=adapt_price, capture_factory=PriceInvocationCapture,
        )
