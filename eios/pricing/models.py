...
class EconomicBasisAssessment(BaseModel):
    ...
    unit:EconomicBasisStatus="PENDING"
    quantity:EconomicBasisStatus="PENDING"
    currency:EconomicBasisStatus="PENDING"
    tax:EconomicBasisStatus="PENDING"
    transport:EconomicBasisStatus="PENDING"
    discount:EconomicBasisStatus="PENDING"
    surcharge:EconomicBasisStatus="PENDING"
    commercial:EconomicBasisStatus="PENDING"
    @property
    def all_resolved(self)->bool:
        return all(value in {"RESOLVED","NOT_APPLICABLE"} for value in self.__dict__.values())
...
class PriceReferenceAssessment(BaseModel):
    ...
    economic_basis:EconomicBasisAssessment|None=None
...
__all__=["AggregationMethod","ComparabilityStatus","EconomicBasisAssessment","EconomicBasisStatus","NormalizationBasis","NormalizationRecord","NormalizationStatus","PRStatus","PriceCounts","PriceIntelligenceInput","PriceIntelligenceResult","PriceReference","PriceReferenceAssessment","RepresentativenessStatus","SufficiencyStatus"]
