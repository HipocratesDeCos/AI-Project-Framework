...
def _execute_reference_business_case(*, variant: str, observe_price: bool,
    ...
    scenario_invoker = (
        build_reference_observed_scenario_coordination_invoker(
            ...
            reference_case_id=reference_case_id,
        ) if observe_scenario else build_provenanced_scenario_coordination_invoker(
...
def execute_reference_business_case_with_scenario_coordination_observation(*, variant: str):
    """Return terminal and same-call synthetic O2 support capture."""
    return _execute_reference_business_case(
        variant=variant, observe_price=False, observe_scenario=True,
    )
